...
| 3 | **Question engine** (the core) | The AI **generates** subject questions from the idea instead of a fixed form; **Deep Analysis** breaks the idea into sections (Cat/Ball/Background), click one → detailed questions about that part. Answers weave into the compiled prompt. Two levels; hybrid (technical picks stay fixed). Browser-e2e verified. (DESIGN.md §4) | ✅ 2026-07-24 |
